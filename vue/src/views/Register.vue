    ...
    <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            ...
            <router-link :to="{name: 'Login'}"
                         class="font-medium text-indigo-600 hover:text-indigo-500">Login into
                your account
            </router-link>
        </p>
    </div>
        ...
        <div class="-space-y-px rounded-md shadow-sm">
            <div>
                ...
                <input id="full-name" name="fullname" type="text"
                       ...
                       required=""
                       class="relative block w-full appearance-none rounded-none  border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Fullname" />
            </div><div>
